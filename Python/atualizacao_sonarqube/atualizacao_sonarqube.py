...
organization_url = 'https://dev.azure.com/cemig/'
    ...
    for definition in definitions:
        ...
        try:
            ...
            if altered:
                ...
                altered_projects.add((project_name, f"https://dev.azure.com/cemig/{project_name}/_build?definitionId={definition.id}"))
        except AzureDevOpsServiceError:
            failed_projects.add((project_name, f"https://dev.azure.com/cemig/{project_name}/_build?definitionId={definition.id}"))
